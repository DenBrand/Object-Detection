...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(   description='split data into training and test data for yolov5',
                                        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('-s',
                        default='custom_data/image_storage',
                        help='source image directory',
                        metavar='image source',
                        dest='imgsrc')
    parser.add_argument('-l',
                        default='custom_data/label_storage',
                        help='source label directory',
                        metavar='label source',
                        dest='lblsrc')
    parser.add_argument('-d',
                        default='custom_data',
                        help='destination directory for images/ and labels/',
                        metavar='destination',
                        dest='dst')
